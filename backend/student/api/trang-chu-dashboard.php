<?php
/**
 * File: trang-chu-dashboard.php
 * Mục đích: API lấy dữ liệu trang chủ sinh viên
 * Method: GET
 * 
 * Endpoint: /backend/student/api/trang-chu-dashboard.php
 * Response: {thanh_cong, du_lieu, thong_bao}
 */
...
try {
    ...
    $controller->layDashboardTrangChu();
} catch (Exception $e) {
