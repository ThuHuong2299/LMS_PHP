<?php
/**
 * File: dashboard-stats-oop.php
 * Mục đích: API lấy thống kê dashboard (phiên bản OOP)
 * Method: GET
 * 
 * ĐÂY LÀ PHIÊN BẢN OOP - SO SÁNH VỚI FILE CŨ dashboard-stats.php
 */
...
$controller->layThongKeDashboard();
